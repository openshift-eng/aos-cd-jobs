    ...
    properties([
        ...
        [
            ...
            parameterDefinitions: [
                ...
                booleanParam(
                    name: 'INSERT_MISSING_ENTRY',
                    description: 'Insert the new bundle entry in version order instead of appending. Use this to fix missing entries that were removed from the catalog.',
                    defaultValue: false,
                ),
                booleanParam(
                    name: 'DRY_RUN',
        ...
        script {
            ...
            withCredentials([
                ...
                if (params.FORCE_BUILD)
                    cmd << "--force"
                if (params.INSERT_MISSING_ENTRY)
                    cmd << "--insert-missing-entry"
