...
class AsyncSignatory:
    ...
    async def close(self):
        ...
        """
        if self._umb.connected:
            await self._umb.disconnect()
    ...
    async def _handle_messages(self):
        ...
        """
        assert self._receiver, "start() was not called"
        async for message in self._receiver.iter_messages():
            ...
            try:
                ...
                if age >= timedelta(hours=1):
                    ...
                    await self._umb.ack(message_id, self._receiver.id)  # discard the message
                    continue
                ...
                await self._umb.ack(message_id, self._receiver.id)  # consume the message
            except Exception:
