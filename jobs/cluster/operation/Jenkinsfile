            ...
            [[$class              : 'ParametersDefinitionProperty',
              parameterDefinitions:
                      [
                              ...
                              [$class: 'hudson.model.ChoiceParameterDefinition', choices: "noop\nreinstall\ndelete\ninstall\nupgrade\nstatus\nsmoketest", name: 'OPERATION', description: 'Operation to perform'],
...
""");
    ...
    if ( ( OPERATION == "install" || OPERATION == "reinstall" || OPERATION == "upgrade" ) && MODE != "silent" ) {
        try {
