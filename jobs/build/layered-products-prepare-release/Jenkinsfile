        ...
        [
            ...
            [
                ...
                parameterDefinitions: [
                    ...
                    booleanParam(
                        name: 'FORCE',
                        description: 'Create a replacement shipment MR and update releases.yml. An open previous MR is closed; replacement is refused if it was merged or production was attempted.',
                        defaultValue: false,
                    ),
                ]
            ],
