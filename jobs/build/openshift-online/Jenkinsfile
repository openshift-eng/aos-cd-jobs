                ...
                [$class: 'ParametersDefinitionProperty',
                 parameterDefinitions:
                         [
                                 ...
                                 [$class: 'hudson.model.StringParameterDefinition', defaultValue: 'jupierce@redhat.com,smunilla@redhat.com,sedgar@redhat.com,vdinh@redhat.com,ahaile@redhat.com', description: 'Failure Mailing List', name: 'MAIL_LIST_FAILURE'],
