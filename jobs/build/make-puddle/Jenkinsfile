...
node('buildvm-devops') {
            ...
            [[$class              : 'ParametersDefinitionProperty',
              parameterDefinitions:
                      [
                              ...
                              [$class: 'hudson.model.StringParameterDefinition', defaultValue: 'jupierce@redhat.com,tdawson@redhat.com,smunilla@redhat.com', description: 'Success Mailing List', name: 'MAIL_LIST_SUCCESS'],
    ...
    echo "${OSE_MAJOR}.${OSE_MINOR}, Group:${PUDDLE_PURPOSE}, Repo:${PUDDLE_TYPE} MAIL_LIST_SUCCESS:[${MAIL_LIST_SUCCESS}], MAIL_LIST_FAILURE:[${MAIL_LIST_FAILURE}]"
    ...
    stage('Make Puddle') {
        try {
            ...
            mail(to: "${MAIL_LIST_FAILURE}",
                    from: "aos-cd@redhat.com",
                    subject: "Error creating puddles: ${OSE_MAJOR}.${OSE_MINOR} ${OSE_GROUP} ${OSE_REPO}",
